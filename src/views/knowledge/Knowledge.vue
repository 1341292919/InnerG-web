  ...
  <div>
    <PageHead title="知识文章">
      <template #buttons>
        <el-button
          type="primary"
          @click="dialogVisible = true; currentArticle = null"
          >新增</el-button
        >
      </template>
    </PageHead>
      ...
      <el-table-column label="操作" fixed="right" width="200">
        <template #default="scope">
          ...
          <el-button
            ...
            >发布</el-button
          >
          <el-button @click="handleUnPublish(scope.row)" v-if="scope.row.status === 1" text type="warning" size="small"
            >下线</el-button
          >
    ...
    <ArticleDialog
      v-model:paramToDialog="dialogVisible"
