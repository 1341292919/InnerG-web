        ...
        <div v-if="messagesList.length === 0" class="message-item ai-message">
          ...
          <div class="message-content">
            <div class="message-bubble">
              <p>
                你好！我是小G，很高兴为你提供心灵健康方面的支持和帮助。无论你有什么问题或需要什么建议，都可以随时告诉我。我会尽力为你提供有用的信息和温暖的陪伴。请问有什么我可以帮你的吗？
              </p>
            </div>
...
const userAvatarUrl = localStorage.getItem('userAvatar')
  ...
  : new URL('../../assets/brand_icon.svg', import.meta.url).href
