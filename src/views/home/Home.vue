    ...
    <div class="content">
      <div class="text">
        ...
        <div class="hero-actions">
          ...
          <el-button size="large" style="border-color: #fff" color="transparent" @click="recordMood"
            >聆听音乐，释放情感</el-button
          >
        </div>
      </div>
      <div class="icon">
        <el-image style="width: 150px; height: 150px" :src="iconUrl" alt="图标" class="icon-image" />
      </div>
    </div>
  </div>
</template>
