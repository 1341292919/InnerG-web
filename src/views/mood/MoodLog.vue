        ...
        <div class="detail-section">
          ...
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="主要情绪">
              <el-tag :type="getEmotionTagType(currentMoodLogDetail.dominantEmotion)">{{
                currentMoodLogDetail.dominantEmotion || '-'
              }}</el-tag>
            </el-descriptions-item>
            <el-descriptions-item label="睡眠质量"
              >{{ currentMoodLogDetail.sleepQuality || '-' }} / 5</el-descriptions-item
            >
            <el-descriptions-item label="压力水平"
              >{{ currentMoodLogDetail.stressLevel || '-' }} / 5</el-descriptions-item
            >
          </el-descriptions>
        </div>
        <div class="detail-section">
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item label="情绪触发因素">{{
              currentMoodLogDetail.emotionTriggers || '无'
            }}</el-descriptions-item>
            <el-descriptions-item label="日记内容">{{
              currentMoodLogDetail.diaryContent || '无'
            }}</el-descriptions-item>
          </el-descriptions>
        </div>
        <div class="detail-section">
            ...
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item label="情绪强度">
                <el-progress
                  ...
                  :color="getEmotionScoreColor(aiData.emotionIntensity || 0)"
                  :stroke-width="8"
                />
              </el-descriptions-item>
