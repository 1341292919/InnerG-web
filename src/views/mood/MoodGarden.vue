  ...
  <div class="hall-wrapper">
    <div class="hall-inner">
      ...
      <ul class="playlist-list">
        <li v-for="item in playlists" :key="item.id" class="playlist-item" @click="handlePlaylistClick(item)">
      ...
      <ul class="song-list">
        <li v-for="song in songsList" :key="song.Id" class="song-item" @click="handleTrackClick(song)">
